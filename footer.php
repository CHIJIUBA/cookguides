            ...
            <div class="container">
                <div class="row footer-p">
                    <div class="col-lg-4 pr-lg-5">
                        <a class="logo" href="index.php"><i class="fa fa-cutlery" aria-hidden="true"></i> Cookguide</a>
                        <p class="mt-4">Cookguide is an agency that provide delicious local Nigerian recipes for any king of local delecacy. 
                            we also provide step by step guide on how you can prepare these delicacy. </p>
                    </div>
                    <div class="col-lg-4 mt-lg-0 mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 column pl-0">
                                <ul class="footer-gd-16">
                                    <li><a href="menu.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Recipe</a></li>
                ...
                <div class="d-flex below-section justify-content-between align-items-center pt-4 mt-5">
                    <div class="columns text-lg-left">
                        <p class="copy-text">@ 2022 Cookguide. All rights reserved. Design by <a
                                href="#" target="_blank">
                                Cookguide</a>
                        </p>
                    </div>
