            ...
            <nav class="navbar navbar-expand-lg stroke px-0">
                <h1>
                    <a class="navbar-brand" href="index.php">
                        <i class="fa fa-cutlery" aria-hidden="true"></i> Cookguide
                    </a>
                </h1>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-lg-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="menu.php">Recipe</a>
                        </li>

                        <li class="nav-item active">
                            <a class="nav-link" href="wiki.php">Wiki Suggest</a>
                        </li>
                        <li class="nav-item active">
                ...
                <div class="search-right">
                    ...
                    <div id="search" class="pop-overlay">
                        <div class="popup">
                            <h4 class="search-pop-text-w3 text-white text-center mb-4">Search Your Favourite Local Food Here
                            </h4>
